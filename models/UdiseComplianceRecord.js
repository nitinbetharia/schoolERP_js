   ...
   const UdiseComplianceRecord = sequelize.define(
      'UdiseComplianceRecord',
      {
         ...
         rte_compliance_status: {
            type: DataTypes.ENUM('compliant', 'partially_compliant', 'non_compliant', 'under_review'),
            allowNull: false,
         ...
         rte_25_percent_admission: {
            ...
            allowNull: false,
            defaultValue: false,
            comment: '25% admission for economically weaker sections (EWS) implemented',
         },
         ...
         nep_2020_implementation: {
            type: DataTypes.ENUM('fully_implemented', 'partially_implemented', 'not_started', 'not_applicable'),
            allowNull: false,
