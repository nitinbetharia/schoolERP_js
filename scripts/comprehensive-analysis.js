...
const scriptAnalysis = [
  ...
  },
  {
    ...
    files: [
      ...
      "scripts/reset-all-databases.js",
      "scripts/reset-demo-database.js",
    ],
...
const pendingItems = [
  {
    ...
    files_needed: [
      "Enhanced UDISESchool model",
      "UDISE school registration service",
  ...
  },
  {
    ...
    files_needed: [
      "AcademicYear model enhancements",
      "Year transition services",
  ...
  },
  {
    ...
    files_needed: [
      "Attendance models",
      "Attendance services and controllers",
      "Reporting APIs",
    ],
  },
  {
...
Object.entries(architectureStatus).forEach(([aspect, status]) => {
  console.log(
    `   ${status.split(" - ")[0]} ${aspect}: ${status.split(" - ")[1] || ""}`,
  );
});
