...
function createStudentController() {
  ...
  async function createStudent(req, res, next) {
    try {
      ...
      res
        .status(201)
        .json(formatSuccessResponse(student, "Student created successfully"));
    } catch (error) {
  ...
  async function getStudentById(req, res, next) {
    try {
      ...
      res.json(
        formatSuccessResponse(student, "Student retrieved successfully"),
      );
    } catch (error) {
      logger.error("Student Controller Error", {
        controller: "student-controller",
  ...
  async function transferStudent(req, res, next) {
    try {
      ...
      res.json(
        formatSuccessResponse(result, "Student transferred successfully"),
      );
    } catch (error) {
      logger.error("Student Controller Error", {
        controller: "student-controller",
  ...
  async function getStudentEnrollments(req, res, next) {
    try {
      ...
      const enrollments = await studentService.getStudentEnrollments(
        tenantCode,
        studentId,
      );
  ...
  async function updateStudentStatus(req, res, next) {
    try {
      ...
      res.json(
        formatSuccessResponse(result, "Student status updated successfully"),
      );
    } catch (error) {
      logger.error("Student Controller Error", {
        controller: "student-controller",
