   ...
   return {
      FeeService: {
         ...
         assignFeeToStudent: {
            ...
            parameters: ['studentId', 'feeStructureId', 'academicYear', 'assignedBy'],
         ...
         bulkAssignFees: {
            ...
            parameters: ['studentIds', 'feeStructureId', 'academicYear', 'assignedBy'],
   ...
   try {
      ...
      if (services.feeService) {
         healthCheck.services.feeService = {
            status: 'healthy',
            type: 'FeeService',
            methods_available: Object.getOwnPropertyNames(Object.getPrototypeOf(services.feeService)).filter(
               (name) => name !== 'constructor' && typeof services.feeService[name] === 'function'
            ).length,
         };
      } else {
         healthCheck.services.feeService = {
