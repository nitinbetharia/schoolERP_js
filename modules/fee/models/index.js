...
function setupFeeAssociations(models) {
  try {
    ...
    if (
      models.FeeStructure &&
      typeof models.FeeStructure.associate === "function"
    ) {
    ...
    if (
      models.StudentFee &&
      typeof models.StudentFee.associate === "function"
    ) {
    ...
    if (
      ...
      typeof models.FeeCollection.associate === "function"
    ) {
    ...
    if (
      ...
      typeof models.FeeInstallment.associate === "function"
    ) {
    ...
    if (
      models.FeeDiscount &&
      typeof models.FeeDiscount.associate === "function"
    ) {
    ...
    if (
      ...
      typeof models.StudentFeeDiscount.associate === "function"
    ) {
