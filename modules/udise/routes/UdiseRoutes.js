...
function createUdiseRoutes() {
   ...
   router.post(
      '/registration',
      validateBody(udiseSchoolRegistrationValidationSchemas.createRegistration), // Q59-ENFORCED validation
   ...
   router.put(
      '/registration/:id',
      validateBody(udiseSchoolRegistrationValidationSchemas.updateRegistration), // Q59-ENFORCED validation
    ...
    * @access  Private (School Admin, System Admin)
    */
   router.post('/registration/:id/submit', UdiseController.registration.submitRegistration);
    ...
    * @access  Private (School Admin, System Admin)
    */
   router.post('/registration/:id/validate', UdiseController.registration.validateRegistration);
   ...
   router.post(
      '/census',
      validateBody(udiseCensusDataValidationSchemas.createCensusData), // Q59-ENFORCED validation
   ...
   router.put(
      '/census/:id',
      validateBody(udiseCensusDataValidationSchemas.updateCensusData), // Q59-ENFORCED validation
    ...
    * @query   academic_year
    */
   router.get('/census/school/:schoolId', UdiseController.census.getCensusDataBySchool);
    ...
    * @access  Private (School Admin, Compliance Officer)
    */
   router.put('/compliance/:id', UdiseController.compliance.updateComplianceRecord);
    ...
    * @query   academic_year
    */
   router.get('/compliance/school/:schoolId', UdiseController.compliance.getComplianceBySchool);
