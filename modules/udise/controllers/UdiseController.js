  ...
  const registrationController = {
    ...
    async createRegistration(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.createRegistration",
          user: req.user,
        });
        next(error);
      }
    ...
    async updateRegistration(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.updateRegistration",
          user: req.user,
        });
        next(error);
      }
    ...
    async submitRegistration(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.submitRegistration",
          user: req.user,
        });
        next(error);
      }
    ...
    async getRegistrations(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getRegistrations",
          user: req.user,
        });
        next(error);
      }
    ...
    async getRegistration(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getRegistration",
          user: req.user,
        });
        next(error);
      }
    ...
    async validateRegistration(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.validateRegistration",
          user: req.user,
        });
        next(error);
      }
  ...
  const censusController = {
    ...
    async createCensusData(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.createCensusData",
          user: req.user,
        });
        next(error);
      }
    ...
    async updateCensusData(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.updateCensusData",
          user: req.user,
        });
        next(error);
      }
    ...
    async getEnrollmentStats(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getEnrollmentStats",
          user: req.user,
        });
        next(error);
      }
    ...
    async getCensusDataBySchool(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getCensusDataBySchool",
          user: req.user,
        });
        next(error);
      }
  ...
  const complianceController = {
    ...
    async createComplianceRecord(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.createComplianceRecord",
          user: req.user,
        });
        next(error);
      }
    ...
    async updateComplianceRecord(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.updateComplianceRecord",
          user: req.user,
        });
        next(error);
      }
    ...
    async getComplianceBySchool(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getComplianceBySchool",
          user: req.user,
        });
        next(error);
      }
  ...
  const reportsController = {
    ...
    async generateReport(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.generateReport",
          user: req.user,
        });
        next(error);
      }
    ...
    async getDashboard(req, res, next) {
      try {
        ...
        logError(error, {
          context: "UdiseController.getDashboard",
          user: req.user,
        });
        next(error);
      }
