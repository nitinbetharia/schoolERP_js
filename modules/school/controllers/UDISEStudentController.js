   ...
   async function bulkRegisterStudents(req, res) {
      try {
         ...
         if (!Array.isArray(registrations) || registrations.length === 0) {
            throw ErrorFactory.validation('Registrations array is required and cannot be empty');
         }

         if (registrations.length > 500) {
            throw ErrorFactory.validation('Maximum 500 students can be registered in one batch');
         }
