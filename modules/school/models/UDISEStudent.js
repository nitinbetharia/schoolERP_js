...
function defineUDISEStudent(sequelize) {
  const UDISEStudent = sequelize.define(
    "UDISEStudent",
    {
      ...
      udise_student_id: {
        ...
        comment:
          "12-digit UDISE+ student ID (11-digit school code + student sequence)",
      },
      pen_number: {
  ...
  UDISEStudent.generateUDISEStudentId = function (
    schoolUdiseCode,
    sequenceNumber,
  ) {
  ...
  UDISEStudent.prototype.validateForSubmission = function () {
    ...
    if (
      this.aadhaar_number &&
      !UDISEStudent.validateAadhaarNumber(this.aadhaar_number)
    ) {
