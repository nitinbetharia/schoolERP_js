   ...
   const UDISEFacilities = sequelize.define(
      'UDISEFacilities',
      {
         ...
         drinking_water_source: {
            type: DataTypes.ENUM('TAP_WATER', 'HAND_PUMP', 'WELL', 'PACKAGED_WATER', 'NO_WATER_FACILITY', 'OTHER'),
            allowNull: true,
         ...
         toilet_water_source: {
            type: DataTypes.ENUM('CONNECTED_TO_WATER_SUPPLY', 'NOT_CONNECTED', 'NO_TOILET'),
            allowNull: false,
