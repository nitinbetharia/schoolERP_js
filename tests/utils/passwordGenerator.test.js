...
describe('Password Generator Tests', () => {
   ...
   describe('Password Strength Validation', () => {
      ...
      test('Penalizes common patterns', () => {
         ...
         expect(weakResult.feedback.some((msg) => msg.toLowerCase().includes('common'))).toBe(true);
      });
      ...
      test('Validates character type requirements', () => {
         ...
         expect(noUppercase.feedback.some((msg) => msg.toLowerCase().includes('uppercase'))).toBe(true);

         expect(noNumbers.feedback.some((msg) => msg.toLowerCase().includes('number'))).toBe(true);
      ...
      test('Penalizes repetitive characters', () => {
         ...
         expect(repetitive.feedback.some((msg) => msg.toLowerCase().includes('repeat'))).toBe(true);
      });
   });
