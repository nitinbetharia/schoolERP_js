...
describe("Phase 7 - Fee Management System", () => {
  ...
  describe("Fee Structure Management", () => {
    ...
    test("Should get fee structure by ID", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/fee-structures/${feeStructureId}`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Student Fee Assignment", () => {
    test("Should assign fee structure to student", async () => {
      ...
      expect(response.body.data.discount_percentage).toBe(
    ...
    test("Should get student fee details", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/fees`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Fee Collection", () => {
    ...
    test("Should get fee collection by ID", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/fee-collections/${feeCollectionId}`,
        )
        .set("Cookie", authCookie);
    ...
    test("Should get student payment history", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/payment-history`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Receipt Management", () => {
    test("Should generate payment receipt", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/fee-collections/${feeCollectionId}/receipt`,
        )
        .set("Cookie", authCookie);
    ...
    test("Should get receipt history for student", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/receipts`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Fee Analytics & Reports", () => {
    ...
    test("Should get monthly collection report", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/fee-analytics/monthly-collection?month=8&year=2024`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Fee Reminders & Notifications", () => {
    ...
    test("Should get reminder history", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/fee-reminders?student_id=${studentId}`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Fee Concession Management", () => {
    ...
    test("Should list student concessions", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/concessions`,
        )
        .set("Cookie", authCookie);
