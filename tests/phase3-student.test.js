...
describe("Phase 3 - Student Management System", () => {
  ...
  describe("Student Registration", () => {
    test("Should register a new student", async () => {
      ...
      expect(response.body.data.admission_number).toBe(
    ...
    test("Should get student by ID", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Student Search & Filtering", () => {
    test("Should search students by name", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students?search=John`,
        )
        .set("Cookie", authCookie);
    ...
    test("Should filter students by class", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students?class_name=Grade 5`,
        )
        .set("Cookie", authCookie);
    ...
    test("Should filter students by academic year", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students?academic_year_id=${academicYearId}`,
        )
        .set("Cookie", authCookie);
  ...
  describe("Student Enrollment", () => {
    test("Should create student enrollment record", async () => {
      ...
      const response = await request(app)
        .post(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/enrollments`,
        )
        .set("Cookie", authCookie)
        .send(enrollmentData);
  ...
  describe("Student Documents", () => {
    test("Should add student document record", async () => {
      ...
      const response = await request(app)
        .post(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/${studentId}/documents`,
        )
        .set("Cookie", authCookie)
        .send(documentData);
  ...
  describe("Student Analytics", () => {
    test("Should get student statistics", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/analytics/stats`,
        )
        .set("Cookie", authCookie);
    ...
    test("Should get class-wise distribution", async () => {
      const response = await request(app)
        .get(
          `/api/v1/trust/${trustId}/schools/${schoolId}/students/analytics/class-distribution`,
        )
        .set("Cookie", authCookie);
