...
try {
    ...
    TenantConfigurationService.getConfigurableModules().then(modules => {
    ...
    TenantConfigurationService.getModuleSchema('student_management').then(schema => {
...
try {
    ...
    const modules = ['student_management', 'academic_settings', 'school_management', 'system_preferences', 'feature_flags'];
    
    modules.forEach(module => {
        TenantConfigurationService.getModuleSchema(module).then(schema => {
