...
async function up(queryInterface, _Sequelize) {
   ...
   try {
      ...
      return {
         ...
         indexes_created: [
            'idx_users_type_active', 'idx_schools_code', 'idx_schools_board',
            'idx_classes_school_level', 'idx_sections_class', 'idx_academic_years_current',
            'idx_students_admission', 'idx_students_school_class_section', 'idx_students_year_status'
         ],
