...
async function up(queryInterface, _Sequelize) {
   ...
   try {
      ...
      await queryInterface.createTable('tenant_configurations', {
         id: {
      ...
      return {
         ...
         indexes_created: [
            'idx_tenant_config_trust', 'idx_tenant_config_active',
            'idx_custom_fields_trust_entity', 'idx_custom_fields_entity_active',
            'idx_fee_config_trust_year', 'idx_fee_config_active_default'
         ],
         constraints_added: [
