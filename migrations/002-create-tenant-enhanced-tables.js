...
async function up(queryInterface, _Sequelize) {
   ...
   try {
      ...
      return {
         ...
         indexes_created: [
            'idx_custom_values_entity', 'idx_custom_values_field',
            'idx_fee_assignment_student_year', 'idx_fee_assignment_config',
            'idx_fee_assignment_active_year', 'idx_fee_transaction_student_year',
            'idx_fee_transaction_number', 'idx_fee_transaction_date_type',
            'idx_fee_transaction_status'
         ],
         constraints_added: [
            'unique_field_value_per_entity',
            'unique_active_assignment_per_student_year'
         ]
      };
