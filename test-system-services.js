...
if (systemServices.systemAuthService) {
   console.log('systemAuthService methods:', Object.keys(systemServices.systemAuthService));
}

if (systemServices.trustService) {
   console.log('trustService methods:', Object.keys(systemServices.trustService));
}
